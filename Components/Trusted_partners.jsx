  ...
  return (
    <div className='trusted_partners'>
       ...
       <h2 data-aos="fade-up">Trusted Partners</h2>
        <p data-aos="c">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
       </div>
        <div className='platform_icons'>
          {
            Trusted_platform_icons.map((items , index)=>{
          return (<div key={items.id}><Image src={items.icon} width={180} height={60} alt="insta-partner" className='insta-partner_images' data-aos="fade-up"></Image></div>)
            })
          }
        </div>
    </div>
