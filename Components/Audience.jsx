  ...
  return (
    <div className='audience'>
      ...
      <div className='audience_card_second'>
        <p className='influencer_name' data-aos="fade-down">@ALIKAMAYA</p>
        ...
        <div>
          ...
          <div>
            ...
            <div className='audience_card_second_inner_card'>
              <div >
                <Image src="/Images/collaborations-img1.jpg" width={220} height={200} alt="collaborations-img1" className='instagram_collaboration_image_one' data-aos="fade-up"></Image>
              ...
              <div className='audience_card_second_inner_card_two'>
                <Image src="/Images/collaborations-img2.jpg" width={220} height={200} alt="collaborations-img2" className='instagram_collaboration_image_two'  data-aos="fade-up"></Image>
